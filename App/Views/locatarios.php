<?php
    ...
    ?>
        <div class="container-fluid container-home bg-light text-primary">
            <h1 class="text-center braketop40 brakebottom40">Página de gestão de locatarios</h1>
            ...
            ?>
            <h2 class="text-center braketop20 brakebottom20">Locatarios</h2>
            ...
            <?php
                ...
                foreach ($dataModel as $dadosModelo):
                    extract($dadosModelo);
                    echo "                <tr id=\"$IdLocatarios\">
                    <td data-label=\"Nome\" data-title=\"Nome\" class=\"align-middle\"><a href=\"".HTTP_PAGE."locatarios/$IdLocatarios\" title=\"Visualizar dados de $NomeLocatarios\" alt=\"Visualizar dados de $NomeLocatarios\">$NomeLocatarios</a></td>
                    <td data-label=\"Email\" data-title=\"Email\" class=\"align-middle\">
                        <a href=\"mailto:$EmailLocatarios\" target=\"_blank\" title=\"Enviar e-mail para $EmailLocatarios\" alt=\"Enviar e-mail para $EmailLocatarios\">$EmailLocatarios</a>
                    </td>
                    <td data-label=\"Telefone\" data-title=\"Telefone\" class=\"align-middle\">
                        <a href=\"tel:+55$TelefoneLocatarios\" target=\"_blank\" title=\"Telefonar para $NomeLocatarios\" alt=\"Telefonar para $NomeLocatarios\">".telefone($TelefoneLocatarios)."</a>
                        &nbsp;|&nbsp;
                        <a href=\"https://wa.me/55$TelefoneLocatarios\" target=\"_blank\" title=\"Chamar $NomeLocatarios no WhatsApp\" alt=\"Chamar $NomeLocatarios no WhatsApp\"><i class=\"fab fa-whatsapp\"></i></a>
                    </td>
                    <td data-label=\"Editar\" class=\"align-middle\">
                        <div class=\"btn-group\">
                            <button type=\"button\" class=\"btn btn-default bg-primary text-light\" onClick=\"editar($IdLocatarios)\"><i class=\"fas fa-user-edit\"></i></button>
                            <button type=\"button\" class=\"btn btn-default bg-primary text-light\" onClick=\"deletar($IdLocatarios)\"><i class=\"fas fa-trash\"></i></button>
                    </div>
                    </td>
                </tr>
";
            ...
            ?>
            <div>Não há locatarios cadastrados</div>
            <?php
            endif;
            ?>
            ...
            <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="labelEdit" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form id="formEditUser" class="form-control" method="POST" action="<?php echo HTTP_PAGE; ?>locatarios/updateUserData">
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="hidden" id="IdLocatarios" name="IdLocatarios" value="" />
            ...
            <div class="modal fade" id="modalAdd" tabindex="-1" aria-labelledby="labelAdd" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="labelAdd">Adicionar locatario</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form id="formAddUser" class="form-control" method="POST" action="<?php echo HTTP_PAGE; ?>locatarios/addUserData">
                            <div class="modal-body">
                                <div class="row g-2 brakebottom10">
                                    <div class="form-floating">
            ...
            <div class="text-center brakebottom40"><button class="btn btn-primary" onclick="openModal('modalAdd')"><i class="fas fa-user-plus"></i> Adicionar Locatário</button></div>
        </div>
